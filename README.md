...
In such situations, there are usually two options to fix the transformation: 1) convert to the desired type or 2) demo and use an overload of the specific operator supporting the different type.
