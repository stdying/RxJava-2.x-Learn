...
public class MaybeNo2Dot0Since {
    ...
    /**
     * Given a base reactive type name, try to demo its source in the current runtime
...
//        System.out.println(path);
        ...
        if (i < 0) {
            System.out.println("Can't demo the base RxJava directory");
            return null;
        }

        // demo end of any potential postfix to /RxJava
